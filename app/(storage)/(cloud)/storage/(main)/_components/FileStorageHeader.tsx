  ...
  return (
    <div className="justify-between text-light-2 flex py-2 items-center p-2 gap-2 w-full">
      ...
      <DialogTrigger asChild>
        <Button variant="outline" className="bg-gradient-to-tr from-gray-500 via-purple-500 to-rose-600 hover:bg-gradient-to-tr hover:from-rose-600 hover:via-sky-600 hover:to-emerald-600 hover:text-light-1 border-none">File Convertor</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Convert Files</DialogTitle>
          <DialogDescription>
           Convert Files and Videos
          </DialogDescription>
        </DialogHeader>
