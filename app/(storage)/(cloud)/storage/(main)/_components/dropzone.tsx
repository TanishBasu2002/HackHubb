          ...
          >
            ...
            {action.is_error ? (
              ...
              <div className="text-slate-400 text-md flex items-center gap-4">
                ...
                >
                  <SelectTrigger className="w-32 outline-none focus:outline-none focus:ring-0 text-center text-slate-200 bg-slate-500 text-md font-medium">
            ...
            {action.is_converted ? (
              ...
              <span
                ...
                className="cursor-pointer hover:bg-slate-400 rounded-full h-10 w-10 flex items-center justify-center text-2xl text-slate-400"
              >
                <MdClose />
              </span>
            )}
          ...
          {is_done ? (
            <div className="space-y-4 w-fit">
              ...
              <Button
                size="lg"
                onClick={reset}
                className="rounded-xl bg-rose-800"
              >
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className=" bg-slate-500 h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-2 border-dashed cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
