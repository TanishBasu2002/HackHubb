  ...
  return (
    <article
      className={`p-7 flex w-full flex-col ${
        isComment
          ? "px-0 xs:px-7 bg-gradient-to-r mt-2 from-slate-950 via-black to-black rounded-full"
          : "rounded-xl bg-gradient-to-bl from-gray-700 via-gray-800 to-gray-950"
      }`}
    >
        ...
        <div className=" w-full flex-1 flex-row gap-4 flex ">
          <div className="flex flex-col items-center ">
            ...
            >
              <Image
                ...
                alt="Profile Image"
                fill
                className="cursor-pointer h-72 w-96 rounded-full"
              />
            </Link>
          ...
          <div className="flex w-full flex-col">
            ...
            {!image && (
              <Link
                href={`/hack/${id}`}
                className="mt-1 text-small-regular font-semibold text-light-2"
              >
                {content}
              </Link>
            )}
            ...
            {image && (
              <>
                <p className="mt-2 text-small-regular font-semibold py-2 text-light-1">
                  {content}
                </p>
