...
const NavigationAction = () => {
  ...
  return (
    <div>
        ...
        <div className="flex mx-3 h-[48px] w-[48px] rounded-[24px] group-hover:rounded-[16px] transition-all overflow-hidden items-center justify-center bg-slate-700 group-hover:bg-gradient-to-tr from-red-500 via-purple-500 to-gray-500">
